...
public class OSSCopyTask extends Task {
    ...
    public OSSCopyTask(OSSClientAgent ossClientAgent,
                       String uploadId,
                       String srcBucket,
                       String dstBucket,
                       String srcKey,
    ...
    public void execute(TaskEngine engineRef) {
        ...
        try {
            UploadPartCopyResult uploadPartCopyResult = ossClientAgent.uploadPartCopy(uploadId, srcBucket, dstBucket,
                    srcKey, dstKey, partSize, beginIndex, partNumber, conf);
