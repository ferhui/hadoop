 ...
 * </ul>
 */
public class TestOSSIO implements Tool {
    // Constants
    private static final Log LOG = LogFactory.getLog(TestOSSIO.class);
    private static final int DEFAULT_BUFFER_SIZE = 1000000;
    private static final String BASE_FILE_NAME = "test_io_";
    private static final String DEFAULT_RES_FILE_NAME = "TestOSSIO_results.log";
    ...
    private static final String USAGE =
            "Usage: " + TestOSSIO.class.getSimpleName() +
                    " [genericOptions]" +
    ...
    private static String getBaseDir(Configuration conf) {
        return conf.get("test.build.data","/benchmarks/TestOSSIO");
    }
    ...
    private static TestOSSIO bench;
    ...
    private void runIOTest(
        ...
        JobConf job = new JobConf(config, TestOSSIO.class);
    ...
    public int run(String[] args) throws IOException {
        ...
        String version = TestOSSIO.class.getSimpleName() + ".1.8";
        ...
        for (int i = 0; i < args.length; i++) {       // parse command line
            if (args[i].startsWith("-read")) {
                ...
                resFileName = args[++i];
            } else if(args[i].equals("-benchmarkDir")) {
                benchmarkDir = args[++i];
            } else {
        ...
        FileSystem fs = FileSystem.get(new Path(benchmarkDir).toUri(), config);
